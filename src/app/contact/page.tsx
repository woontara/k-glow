                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-[#636E72]">contact@k-glow.kr</p>
                      <p className="text-[#636E72]">support@k-glow.kr</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 group">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#A4B4A8] to-[#849488] rounded-2xl flex items-center justify-center text-white flex-shrink-0 shadow-lg transition-transform duration-300 group-hover:scale-110">
                      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                    </div>
                    <div>
                      <p className="font-semibold text-[#2D3436] mb-1">전화</p>
                      <p className="text-[#636E72]">+82-2-1234-5678</p>
                      <p className="text-[#636E72]">+82-10-9876-5432</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 group">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#D4C4A8] to-[#B4A488] rounded-2xl flex items-center justify-center text-white flex-shrink-0 shadow-lg transition-transform duration-300 group-hover:scale-110">
                      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <p className="font-semibold text-[#2D3436] mb-1">주소</p>
      ...
      <section className="relative py-24 px-6">
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl font-semibold text-[#2D3436]">
              오시는 길
            </h2>
          </div>
          <div className={`card-luxury rounded-[2rem] overflow-hidden ${mounted ? 'animate-reveal delay-600' : 'opacity-0'}`}>
            <div className="h-80 bg-gradient-to-br from-[#E8EEF2] to-[#F5F7F9] flex items-center justify-center relative">
              <div className="absolute inset-0 bg-mesh opacity-50" />
              <div className="relative text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-[#8BA4B4] to-[#6B8A9A] rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl animate-float">
                  <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <p className="font-medium text-[#2D3436] text-lg mb-2">서울시 강남구 테헤란로 123</p>
                <p className="text-[#636E72]">지하철 2호선 강남역 3번 출구에서 도보 5분</p>
              </div>
            </div>
          </div>
        </div>
